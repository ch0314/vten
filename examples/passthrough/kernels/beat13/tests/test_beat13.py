...
class TestBeat13(TestScenario):
    """104-bit bus: 13 bytes/beat, prime number of bytes."""
    kernel = "beat13"
    ...
    def run(self, ctx, cfg):
        ...
        from beat13_kernel import Beat13Kernel
        k = ctx.instantiate(Beat13Kernel, N=cfg.get("N", 1300))
...
class TestBeat13Probe(TestScenario):
    kernel = "beat13"
