...
class Int32X2Kernel(Kernel):
    spec = "kernels/int32_x2/kernel_spec.yaml"
    data_in = Tensor(shape=("${N}",), dtype=torch.int32, interface="input_stream")
    data_out = Tensor(shape=("${N}",), dtype=torch.int32, interface="output_stream")
